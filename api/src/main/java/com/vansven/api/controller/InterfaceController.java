...
import com.vansven.api.vo.interfaceinfo.*;
...
public class InterfaceController {
    ...
    public BaseResponse<Object> invokeGetEntityByPost(@RequestBody InvokePostRequest invokePostRequest,
        ...
        Person person = invokePostRequest.getPerson(); //json转 person 对象 反序列化
        ClientService client = new ClientService(publicKey, privateKey);
        ResponseEntity<Person> responseEntity = client.getEntityByPost(person);
    ...
    public BaseResponse<Object> invokeGetEntityByGet(@RequestBody InvokeGetRequest invokeGetRequest,
        ...
        ResponseEntity<String> responseEntity = clientService.getNameByGet(requestParams);
